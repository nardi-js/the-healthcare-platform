          ...
          <div className="absolute inset-0 bg-gradient-to-br from-purple-500/70 to-pink-500/70">
            <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
              ...
              <p className="text-sm opacity-90">
                Join our healthcare community and make a difference in people's
                lives.
              </p>
            </div>
          </div>
        ...
        <div className="w-full md:w-1/2 p-8 space-y-6">
          ...
          <form onSubmit={handleSignIn} className="space-y-5">
            ...
            <p className="mt-8 text-center text-sm text-gray-600">
              ...
              <Link
                href="/sign-up"
                className="font-medium text-purple-600 hover:text-purple-500 transition-colors duration-150 ease-in-out"
              >
                Sign up
              </Link>
            </p>
